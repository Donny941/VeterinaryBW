...
namespace Veterinary.Migrations
{
    ...
    [Migration("20260107150621_addedinstocktoproduct")]
    partial class addedinstocktoproduct
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Veterinary.Models.Animal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Veterinary.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Veterinary.Models.Recovery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("RecoveryStartDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Veterinary.Models.Sale", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Veterinary.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Veterinary.Models.Visit", b =>
                {
                    ...
                    b.Property<string>("ObjectiveExamination")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Veterinary.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Veterinary.Models.Recovery", b =>
                {
                    b.HasOne("Veterinary.Models.Animal", "Animal")
                        .WithOne("Recovery")
                        .HasForeignKey("Veterinary.Models.Recovery", "AnimalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Veterinary.Models.Sale", b =>
                {
                    b.HasOne("Veterinary.Models.Product", "Product")
                        .WithMany("Sales")
